...
<head>
    ...
    <title>SAÜ Mezunları Platformu - Video</title>
...
<main class="container mt-4">
    <c:set var="videoId" value="${param.id}" scope="request" />
    <jsp:include page="/GetVideoServlet" flush="true">
        <jsp:param name="id" value="${videoId}" />
    </jsp:include>
    ...
    <p class="text-muted">Yükleyen: ${video.uploaderName}</p>
    ...
    <div class="card mt-4">
        ...
        <div class="card-body">
            <c:if test="${not empty sessionScope.loggedIn}">
                <form action="AddVideoCommentServlet" method="post">
                    <input type="hidden" name="videoId" value="${video.id}">
                    <input type="hidden" name="commentType" value="video">
