...
@WebServlet(name = "EditThreadServlet", value = "/EditThreadServlet")
public class EditThreadServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        // Debug için eklenen satırlar
        System.out.println("Düzenle doPost - threadId: " + threadId + ", title: " + title + ", content: " + content);
